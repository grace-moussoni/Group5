-- ============================================================
-- PROJET OLIST E-COMMERCE - S9 DDL
-- Livrable complet
-- Base de données : OlistCommerce
-- ============================================================

-- ============================================================
-- Exercice 1 : Créer la base de données
-- ============================================================
...
-- ============================================================
-- Exercice 2 : Créer les tables racines (sans clés étrangères)
-- ============================================================
...
-- ============================================================
-- Exercice 3 : Créer les tables dépendantes (avec clés étrangères)
-- ============================================================
...
-- Table order_items (dépend de orders, products, sellers)
...
-- Table order_payments (dépend de orders)
...
-- Table order_reviews (dépend de orders)
...
-- ============================================================
-- Exercice 4 : Ajouter une contrainte CHECK sur review_score
-- ============================================================

ALTER TABLE order_reviews
ADD CONSTRAINT CHK_review_score_1_5
...
-- ============================================================
-- Exercice 6 : Ajouter product_brand et is_active à products
-- ============================================================
...
-- ============================================================
-- Exercice 7 : Table temporaire (entraînement)
-- ============================================================

-- a) Créer une table temporaire
...
-- b) Renommer la table avec sp_rename
...
-- d) Supprimer la table temporaire
...
-- ============================================================
-- Exercice 10 : Synthèse - Vérification du schéma
-- ============================================================
